...
//                saleID_View.setText("");
                ...
                UserName.setText(data.get(position).getCustomerName());
                HandPhone3.setText(data.get(position).getTelphone());//来电电话
//                TelePhone.setText(data.get(position).getCustomerInfo().getTelphone());//电话
                Address.setText(data.get(position).getCustomerAddress());
                GoodsName.setText(data.get(position).getCustomerTypeName());//商品
                userid.setText(data.get(position).getCustomerID());
                saleID_View.setText("卡号：");
                saleID.setText(data.get(position).getCustomerCardID());
