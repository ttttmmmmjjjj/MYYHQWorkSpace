...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private static final String T_B_AddressInfo="create table if not exists T_B_ADDRESS(ID TEXT,AeraCode TEXT," +
            "QuName TEXT,JieDao TEXT)";//地址配置信息表
    private static final String T_B_Sale="create table if not exists T_B_SALE(SaleID TEXT ," +
            ...
            "AssignTime TEXT,EmployeeID TEXT,AllPrice TEXT,InsertTime TEXT,Telephone TEXT,RealPriceInfo TEXT)";//销售表
    private static final String T_B_SaleDetail="create table if not exists T_B_SALEDETAIL(SaleID TEXT ," +
            "QPType TEXT,QPName TEXT,PlanSendNum TEXT,PlanReceiveNum TEXT,ReceiveNum TEXT,SendNum TEXT,QTPrice TEXT,EmployeeID TEXT,StationID TEXT,IsEx TEXT,InsertTime TEXT)";//销售详细表
    private static final String T_B_CustomerInfo="create table if not exists T_B_CUSTOMERINFO(SaleID TEXT,UserID TEXT," +
            ...
            "StopSupplyType7 TEXT,StopSupplyType8 TEXT,UnInstallType1 TEXT,UnInstallType2 TEXT,UnInstallType3 TEXT,UnInstallType4 TEXT," +
            "UnInstallType5 TEXT,UnInstallType6 TEXT,UnInstallType7 TEXT,UnInstallType8 TEXT,UnInstallType9 TEXT,UnInstallType10 TEXT," +
            "UnInstallType11 TEXT,UnInstallType12 TEXT,InspectionDate TEXT,EmployeeID TEXT,CustomerName TEXT,IState TEXT,InspectionMan TEXT," +
            " InsertTime TEXT,Telephone TEXT,Address TEXT,TagID TEXT)";//用户表
    //巡检信息配置表
    ...
    private static final String T_B_AJnfo="create table if not exists T_B_AJINFO"
            ...
            " EmployeeID TEXT,InsertTime TEXT,TagID TEXT)";//用户表
    //整改表
    private static final String T_B_ZGInfo="create table if not exists T_B_UserRectifyInfo"
            ...
            + " UnInstallType9 TEXT,UnInstallType10 TEXT,UnInstallType11 TEXT,UnInstallType12 TEXT,"
            + " RelationID TEXT,IsInspected TEXT,StationID  TEXT,RectifyDate TEXT,OperationResult TEXT,Remark TEXT," +
            " EmployeeID TEXT,InsertTime TEXT,TagID TEXT)";
    //交易SaleDetail
