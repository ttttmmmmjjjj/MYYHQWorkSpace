...
public class SaleListActivity extends AppCompatActivity implements ImplSearchAssignSale,
    ...
    private void showPopupWindow(View view) {
        ...
        query.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //查询
                Intent i=new Intent(SaleListActivity.this,CountActivity.class);
                startActivity(i);
            }
        });
        ...
        setting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 20161117 上传
                new UpLoadHistoryTask(SaleListActivity.this).execute();
...
//                listview.setSelectionFromTop(scrolledX, scrolledY);
        ...
        delivery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                Intent login=new Intent(SaleListActivity.this,UserLoginByReadActivity.class);//有卡无卡
//                login.putExtra("LR","1");//上门配送时用户登录
//                startActivity(login);
                choice.show();
            }
        });
...
//                txt_warn.setText("新消息:" + count + "条");
    ...
    public void registNotificatuinReciver() {
        ...
        itf.addAction("com.hsic.fxqpmanager.activity.NewsReceiver");
