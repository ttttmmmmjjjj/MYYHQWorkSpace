    ...
    private void innitView() {
        ...
        delivery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                choice.show();
//                Intent login=new Intent(RectiftyListActivity.this,UserLoginByReadActivity.class);
//                login.putExtra("LR","3");//上门整改时用户登录
//                startActivity(login);//有卡无卡
            }
        });
    ...
    private void setUIData(String msg){
        ...
        rectifyListAdapter=new RectifyListAdapter(this,list);
