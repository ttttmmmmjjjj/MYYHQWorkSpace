package com.hsic.sy.doorsale.adapter;
...
import com.hsic.sy.doorsale.Activity.PlaceOrderActivity;
...
//        hd.txt_ID.setVisibility(View.GONE);
        ...
        hd.txt_GoodsName.setText(goodsInfo.getGoodsName()+"  "+goodsInfo.getGoodsCount()+"个");
