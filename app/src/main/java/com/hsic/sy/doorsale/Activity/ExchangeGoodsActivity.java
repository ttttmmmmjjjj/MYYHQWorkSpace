...
import com.hsic.sy.bll.DataUtils;
import com.hsic.sy.doorsale.lisenter.ImplExchangeGoods;
import com.hsic.sy.doorsale.lisenter.ImplGetOrderBySaleIdTask;
import com.hsic.sy.doorsale.task.ExchangeGoodsTask;
...
public class ExchangeGoodsActivity extends AppCompatActivity implements ImplGetOrderBySaleIdTask,
        ImplExchangeGoods,OnDismissListener, OnItemClickListener{
        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener(){
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if(menuItemId==R.id.action_search){
                    Intent s=new Intent(ExchangeGoodsActivity.this,ScanOneDecodeActivity.class);
