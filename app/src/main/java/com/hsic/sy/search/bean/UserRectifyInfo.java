...
public class UserRectifyInfo {
	public String deliveraddress;//���͵�ַ
	public String userstat ;//�û�״̬
	public String ex_userid;//�û�״̬2
	public String userid ;//�������
	public String RectifyStatus;//����״̬
	public String RectifyMan ;//������Ա
	public String userCardStatus ;//�û���״̬
	public String userCardID ;//�û���ID
	public String username;//�û�����
	public String telephone;//�̶��绰
	public String handphone ;//�ֻ�
	public String handphone2 ;//�ֻ�2
	public String handphone3 ;//�ֻ�3
	public String usertype ;/// �û����� M�г��û� P�ƻ��û�
	public String custom_type;//�ͻ����� ����
	public String extendValue1;//�ͻ����� ��������
	public String insurance ;//״̬ 0δ���� 1������
	public String fireno2 ;//��������
	public String InspectionStatus;//Ѳ��״̬
	public String Last_InspectionStatus;
	public String InspectionDate ;//Ѳ������
	public String IsBackup;//����ƿ
	public String  id;//��¼Ψһ��ʶ
	public String empname ;//Ա�� ����
	...
	public String IsInspected;// ���ر�ʶ 0��û����Ѳ�죬1������Ѳ�죬2����Ϣ���ϴ�
	
	public String imagepath;
	public String stopYY;
	public String UnistYY;
	public String isPrint;
	public String stationid ;//վ��
	...
	public String getEx_userid() {
		return ex_userid;
	}
	public void setEx_userid(String ex_userid) {
		this.ex_userid = ex_userid;
	}
	...
	public void setRectifyMan(String rectifyMan) {
		RectifyMan = rectifyMan;
	}
	...
	public String getFireno2() {
		return fireno2;
	}
	public void setFireno2(String fireno2) {
		this.fireno2 = fireno2;
	}
	...
	public String getStopYY() {
		return stopYY;
	}
	public void setStopYY(String stopYY) {
		this.stopYY = stopYY;
	}
	public String getUnistYY() {
		return UnistYY;
	}
	public void setUnistYY(String unistYY) {
		UnistYY = unistYY;
	}
