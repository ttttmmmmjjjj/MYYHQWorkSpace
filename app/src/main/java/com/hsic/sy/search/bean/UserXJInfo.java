...
public class UserXJInfo {
	...
	public String userCardStatus;// / �û���״̬��ҵ�����ݣ�
	public String whpqk;// / Ƿƿ
	public String ownBottle;// ��ƿ
	public String insurance;// ��ҵ�����ݣ�
	public String fireno2;// ��ҵ�����ݣ�������Ƥ������
	...
	public String InspectionDate;// ���ر�ʶ
	...
	public String getOwnBottle() {
		return ownBottle;
	}

	public void setOwnBottle(String ownBottle) {
