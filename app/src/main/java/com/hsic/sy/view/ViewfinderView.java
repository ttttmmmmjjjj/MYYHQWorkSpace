...
import com.hsic.sy.camera.CameraManager;
...
public final class ViewfinderView extends View {
  ...
  private static final int    CORNER_RECT_WIDTH             =   8;  //ɨ�����߽ǵĿ�
  private static final int    CORNER_RECT_HEIGHT            =   40; //ɨ�����߽ǵĸ�
  private static final int    SCANNER_LINE_MOVE_DISTANCE    =   5;  //ɨ�����ƶ�����
  private static final int    SCANNER_LINE_HEIGHT           =   10;  //ɨ���߿��
...
//      canvas.drawRect(frame.left, scannerStart, frame.right, scannerStart + SCANNER_LINE_HEIGHT, paint);
  ...
  // ����ɨ�����߿� Draw a two pixel solid black border inside the framing rect
  ...
  // ����ģ������ Draw the exterior (i.e. outside the framing rect) darkened
