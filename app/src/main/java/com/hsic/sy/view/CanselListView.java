...
public class CanselListView extends ListView{
	...
	public CanselListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		View view = mInflater.inflate(R.layout.layout_cansel_btn, null);
		// ɾ����ť
