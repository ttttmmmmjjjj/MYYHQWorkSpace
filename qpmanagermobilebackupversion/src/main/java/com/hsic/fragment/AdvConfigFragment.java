...
public class AdvConfigFragment extends PreferenceFragment implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		endPointDefaultString = getActivity().getResources().getString(
				R.string.qp_default);
		WebServer = getActivity().getResources().getString(R.string.qp_default);
		WebServerPort=getActivity().getResources().getString(R.string.gpport_default);
		...
		WebServerPort=getActivity().getResources().getString(
