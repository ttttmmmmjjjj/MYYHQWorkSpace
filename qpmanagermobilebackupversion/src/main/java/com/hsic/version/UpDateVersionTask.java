    ...
    protected Map<String, String> doInBackground(Void... params) {
        ...
        try {
            ...
            String path = "http://"+
                    ...
                    .getString("WebServerPort", port)+"/SHLPGPhoneWsJH/AppVersion.xml";
