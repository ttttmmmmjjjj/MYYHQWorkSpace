...
public class VersionHelper {
    ...
    public boolean downLoadApk(){
		...
		if(connect==null){
			...
			boolean download = mysftp.download("/APP/", "QPManagerMoblie.apk", file.getAbsolutePath(), connect);
			if(download){
				flag=true;
			}
		}
    ...
    public void installApk(){
    	  ...
    	  intent.setDataAndType(Uri.fromFile(new File(Environment
    	        .getExternalStorageDirectory(), "/downLoad/QPManagerMobileBak.apk")),
    ...
    public void uninstallApk(){
    	Uri packageURI = Uri.parse("com.hsic.activity.qpmanagermobilebackupversion");
